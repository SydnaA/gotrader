...
class LGChatController : UIViewController, UITableViewDelegate, UITableViewDataSource, LGChatInputDelegate {
    ...
    */
    ...
    private func setupNavBar() {
        navView = UIView(frame: CGRect(x: 0, y: 0, width: self.view.bounds.width, height: self.view.bounds.height*0.1))
        navView.backgroundColor = UIColor(red: (92/255.0), green: (165/255.0), blue: (248/255.0), alpha: 1)
    ...
    private func setupTableView() {
        ...
        //tableView.frame = CGRect(x: 0, y: self.view.bounds.height*0.1, width: self.view.bounds.width, height: self.view.bounds.height*0.9)
    ...
    private func tableViewConstraints() -> [NSLayoutConstraint] {
        ...
        let topConstraint = NSLayoutConstraint(item: tableView, attribute: .Top, relatedBy: .Equal, toItem: navView, attribute: .Bottom, multiplier: 1, constant: 0.0)
        let bottomConstraint = NSLayoutConstraint(item: tableView, attribute: .Bottom, relatedBy: .Equal, toItem: chatInput, attribute: .Top, multiplier: 1.0, constant: 0.0)
